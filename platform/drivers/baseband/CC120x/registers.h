/* registers.h - Register definitions for the TI CC1200 */
...
#ifndef BASEBAND_DRIVERS_CC1200_REGS_H_
#define BASEBAND_DRIVERS_CC1200_REGS_H_

#define CC1200_RF_NON_EXT_SPACE_REGS	42
#define CC1200_RF_EXT_SPACE_REGS	58

/* Access types (see Section 3.2) */
// The chip status byte is returned on the SO line both when the
// address is sent on the SI line as well as when data are written.

// Single Register Access

// ~{R/W} = 1. The register accessed is determined by the address in A_{5-0}
#define CC1200_ACCESS_RD BIT(7)
// ~{R/W} = 0. Exactly one data byte is expected after the address byte.
#define CC1200_ACCESS_WR (0x00)

// Burst Register Access

/** Use Single Access to set ~{R/W}. Access is terminated by setting ~{CS} high.
...
//IOCFGx - GPIOx Pin Configuration
...
// SYNCx - Sync Word Configuration 
#define CC1200_REG_SYNC3 (0x04) // [31:24]
#define CC1200_REG_SYNC2 (0x05) // [23:16]
#define CC1200_REG_SYNC1 (0x06) // [15:8]
#define CC1200_REG_SYNC0 (0x07) // [7:0]
...
#endif /* BASEBAND_DRIVERS_CC1200_REGS_H_ */
