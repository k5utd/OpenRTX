...
{
	0x00, CC1200::IOCFG2, 0x08,
    0x00, CC1200::IOCFG0, 0x09,
    0x00, CC1200::SYNC_CFG1, 0x1F,
    0x00, CC1200::DEVIATION_M, 0x9F, //deviation - about 3kHz full scale
    0x00, CC1200::MODCFG_DEV_E, 0x00, //deviation
    0x00, CC1200::DCFILT_CFG, 0x5D,
    0x00, CC1200::PREAMBLE_CFG1, 0x00,
    0x00, CC1200::PREAMBLE_CFG0, 0x8A,
    0x00, CC1200::IQIC, 0xCB,
    0x00, CC1200::CHAN_BW, 0xAC, //RX filter BW - 9.5kHz
    0x00, CC1200::MDMCFG1, 0x00,
    0x00, CC1200::MDMCFG0, 0x45,
    0x00, CC1200::SYMBOL_RATE2, 0x3F, //symbol rate 2 - 1.2k sym/s
    0x00, CC1200::SYMBOL_RATE1, 0x75, //symbol rate 1
    0x00, CC1200::SYMBOL_RATE0, 0x10, //symbol rate 0
    0x00, CC1200::AGC_REF, 0x37,
    0x00, CC1200::AGC_CS_THR, 0xEC,
    0x00, CC1200::AGC_CFG3, 0x11,
    0x00, CC1200::AGC_CFG1, 0x51,
    0x00, CC1200::AGC_CFG0, 0x87,
    0x00, CC1200::FIFO_CFG, 0x00,
    0x00, CC1200::FS_CFG, 0x14,
    0x00, CC1200::PKT_CFG2, 0x03,
    0x00, CC1200::PKT_CFG1, 0x00,
    0x00, CC1200::PKT_CFG0, 0x20,
    0x00, CC1200::PA_CFG1, 0x03, //output power - 0x03..0x3F (doesn't matter for RX)
    0x00, CC1200::PKT_LEN, 0xFF,
	0x2F, CC1200::IF_MIX_CFG, 0x1C,
	0x2F, CC1200::FREQOFF_CFG, 0x02, //AFC, 0x22 - on, 0x02 - off
	0x2F, CC1200::ECG_CFG, 0x0C, //external oscillator's frequency is 40 MHz
	0x2F, CC1200::MDMCFG2, 0x09, //16x upsampler, CFM enable
	0x2F, CC1200::FREQ2, 0x57, //frequency - round((float)435000000/5000000*(1<<16))=0x570000
	0x2F, CC1200::FREQ1, 0x00, //frequency
	0x2F, CC1200::FREQ0, 0x00, //frequency
	0x2F, CC1200::IF_ADC1, 0xEE,
	0x2F, CC1200::IF_ADC0, 0x10,
	0x2F, CC1200::FS_DIG1, 0x07,
	0x2F, CC1200::FS_DIG0, 0xAF,
	0x2F, CC1200::FS_CAL1, 0x40,
	0x2F, CC1200::FS_CAL0, 0x0E,
	0x2F, CC1200::FS_DIVTWO, 0x03,
	0x2F, CC1200::FS_DSM0, 0x33,
	0x2F, CC1200::FS_DVC0, 0x17,
	0x2F, CC1200::FS_PFD, 0x00,
	0x2F, CC1200::FS_PRE, 0x6E,
	0x2F, CC1200::FS_REG_DIV_CML, 0x1C,
	0x2F, CC1200::FS_SPARE, 0xAC,
	0x2F, CC1200::FS_VCO0, 0xB5,
	0x2F, CC1200::XOSC5, 0x0E,
	0x2F, CC1200::XOSC1, 0x03,
	0x2F, CC1200::SERIAL_STATUS, 0x08
};
...
const uint8_t cc1200_tx_settings[51*3] =
{
	...
	0x00, CC1200::IOCFG0, 0x09,
	0x00, CC1200::SYNC_CFG1, 0x1F,
	0x00, CC1200::DEVIATION_M, 0x06, //deviation - 5kHz full scale
	0x00, CC1200::MODCFG_DEV_E, 0x01, //deviation
	0x00, CC1200::DCFILT_CFG, 0x5D,
	0x00, CC1200::PREAMBLE_CFG1, 0x00,
	0x00, CC1200::PREAMBLE_CFG0, 0x8A,
	0x00, CC1200::IQIC, 0xCB,
	0x00, CC1200::CHAN_BW, 0xAC, //RX filter BW - 9.5kHz (doesn't matter for TX)
	0x00, CC1200::MDMCFG1, 0x00,
	0x00, CC1200::MDMCFG0, 0x45,
	0x00, CC1200::SYMBOL_RATE2, 0x83, //symbol rate 2 - 24k symb/s
	0x00, CC1200::SYMBOL_RATE1, 0xA9, //symbol rate 1
	0x00, CC1200::SYMBOL_RATE0, 0x2A, //symbol rate 0
	0x00, CC1200::AGC_REF, 0x37,
	0x00, CC1200::AGC_CS_THR, 0xEC,
	0x00, CC1200::AGC_CFG3, 0x11,
	0x00, CC1200::AGC_CFG1, 0x51,
	...
	0x00, CC1200::PKT_CFG1, 0x00,
	0x00, CC1200::PKT_CFG0, 0x20,
	0x00, CC1200::PA_CFG1, 0x03, //output power - 0x03..0x3F
	0x00, CC1200::PKT_LEN, 0xFF,
	0x2F, CC1200::IF_MIX_CFG, 0x1C,
	0x2F, CC1200::FREQOFF_CFG, 0x22,
	0x2F, CC1200::ECG_CFG, 0x0C, //external oscillator's frequency is 40 MHz
	0x2F, CC1200::MDMCFG2, 0x09, //16x upsampler, CFM enable
	0x2F, CC1200::FREQ2, 0x57, //frequency - round((float)435000000/5000000*(1<<16))=0x570000
	0x2F, CC1200::FREQ1, 0x00, //frequency
